...
# && pip install -r requirements.txt \
  ...
  && wget https://github.com/chdb-io/chdb/releases/download/v2.0.0b0/chdb-2.0.0b0-cp38-cp38-manylinux_2_5_x86_64.manylinux1_x86_64.manylinux_2_17_x86_64.manylinux2014_x86_64.whl -P /tmp/ \
  && pip install /tmp/*.whl \
